...
import com.acgist.killer.pojo.config.SystemConfig;
import com.acgist.killer.utils.BrowseUtils;
import com.acgist.killer.utils.PlatformUtils;
...
public class TrayMenu extends ContextMenu {
	...
	private void enableTray() {
		...
		try {
			...
			trayIcon = new TrayIcon(image, "ACGIST-KILLER");
