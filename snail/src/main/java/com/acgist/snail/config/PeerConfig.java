...
public final class PeerConfig extends PropertiesConfig {
    ...
    public enum Type {
         ...
         * 索引数据
         */
        private static final Type[] INDEX = EnumUtils.index(Type.class, Type::getId);
    ...
    public enum ExtensionType {
        ...
        public static final ExtensionType of(byte id) {
            ...
            for (final ExtensionType type : types) {
                if(type.id == id) {
                    return type;
                }
            }
    ...
    public enum MetadataType {
        ...
        public static final MetadataType of(byte id) {
            ...
            for (final MetadataType type : types) {
                if(type.id == id) {
                    return type;
                }
            }
     ...
     * @author acgist
     * 
     * @see ExtensionType#UT_HOLEPUNCH
     */
    public enum HolepunchType {
        ...
        public static final HolepunchType of(byte id) {
            ...
            for (final HolepunchType type : types) {
                if(type.id == id) {
                    return type;
                }
            }
